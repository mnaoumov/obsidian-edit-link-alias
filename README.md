...
2. Downloading `edit-link-alias-demo-vault.zip` from the [Releases](https://github.com/mnaoumov/obsidian-edit-link-alias/releases). It unzips into a single `edit-link-alias-demo-vault-<version>` folder.
